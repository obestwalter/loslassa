...
Starts a local development server (see script output for a link to the page). All files in the project folder are being watched and if something changes the project is rebuild.
