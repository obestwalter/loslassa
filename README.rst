...
As the description says: useful for simple web pages - if it get's more involved you need a bit more, which in this case provides by the`sphinx <http://sphinx-doc.org>`_ documentation generator.
